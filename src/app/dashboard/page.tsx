...
import {
  faChartLine, faUsers, faUserPlus, faCalendarAlt, faDna
    ...
    datasets: [
      {
        ...
        data: [70, 80, 90, 110, 125],
        borderColor: 'rgb(35, 188, 239)',
        backgroundColor: 'rgba(35, 188, 239, 0.3)',
        fill: true,
        tension: 0.4,
        pointBackgroundColor: 'rgb(35, 188, 239)',
        pointBorderColor: '#fff',
        pointHoverRadius: 7,
        pointHoverBackgroundColor: 'rgb(35, 188, 239)'
      },
      {
        label: 'Onboarded',
